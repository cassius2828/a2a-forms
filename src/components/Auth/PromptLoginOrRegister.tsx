    ...
    <AuroraContainer>
      <div className="w-full md:w-1/2 lg:w-1/3 mx-auto p-4 bg-neutral-900 rounded-lg shadow-md mt-20 text-center">
        ...
        <p className="text-sm text-gray-200 mb-6">
          To create an Athlete Spotlight, you need to either sign in or create
          an account. Your post will be subject to review before being
          published.
          <br />
          <br />
          If you create an account, you will be able to edit your spotlight in
          the future. Without an account, you will not be able to make any
