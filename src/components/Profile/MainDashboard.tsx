...
import { ClassesRestOp, Client, StatusKey } from "../../lib/types";
                    ...
                    <tbody>
                      {days.map((day) => (
                        <Fragment key={day.dateTime}>
                          <tr className="text-sm/6 text-gray-200">
                            <th
                              scope="colgroup"
                              colSpan={3}
                          ...
                          {day.transactions.map((transaction) => (
                            <tr key={transaction.id}>
                              ...
                              <td className="hidden py-5 pr-6 sm:table-cell">
                                <div className="text-sm/6 text-gray-200">
                                  {transaction.client}
                                </div>
                                <div className="mt-1 text-xs/5 text-gray-500">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
              <div className="flex items-center justify-between">
                ...
                <a
                  href="#"
                  className="text-sm/6 font-semibold text-green-600 hover:text-green-500"
                >
              ...
              >
                {clients.map((client) => (
                  ...
                  >
                    <div className="flex items-center gap-x-4 border-b border-gray-200/5 bg-gray-50 p-6">
                      <img
                        alt={client.name}
                        src={client.imageUrl}
                        className="size-12 flex-none rounded-lg bg-white object-cover ring-1 ring-gray-200/10"
                      />
                      <div className="text-sm/6 font-medium text-gray-200">
                        {client.name}
                      </div>
                      <Menu as="div" className="relative ml-auto">
                        ...
                        <MenuItems
                          transition
                          className="absolute right-0 z-10 mt-0.5 w-32 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-200/5 transition focus:outline-none data-[closed]:scale-95 data-[closed]:transform data-[closed]:opacity-0 data-[enter]:duration-100 data-[leave]:duration-75 data-[enter]:ease-out data-[leave]:ease-in"
                        >
                          <MenuItem>
                            <a
                              href="#"
                              className="block px-3 py-1 text-sm/6 text-gray-200 data-[focus]:bg-gray-50 data-[focus]:outline-none"
                            >
                              View
